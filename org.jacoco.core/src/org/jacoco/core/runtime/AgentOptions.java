...
public final class AgentOptions {
    ...
    public static final String DEFAULT_BASEBRANCH = BRANCH_PREFIX + "master";
    ...
    //baseBranch
    public static final String BASEBRANCH = "baseBranch";

    //diffBranch
    public static final String DIFFBRANCH = "diffBranch";
     ...
     *
     * @param properties {@link Properties} object to read configuration options from
     */
    ...
    public String getBaseBranch() {
        return getOption(BASEBRANCH, DEFAULT_BASEBRANCH);
    }

    public String getDiffBranch() {
        return getOption(DIFFBRANCH, DEFAULT_BASEBRANCH);
    }
     ...
     *
     * @param append <code>true</code>, when the output should be appended
     */
     ...
     * instrumented.
     *
     * @param include <code>true</code> if bootstrap classes should be instrumented
     */
